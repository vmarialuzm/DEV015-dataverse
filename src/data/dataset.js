export default [
  {
    id: "machu-picchu",
    name: "Machu Picchu",
    shortDescription: "Ciudadela inca ubicada en los Andes peruanos, patrimonio mundial.",
    description: "Machu Picchu es una antigua ciudad inca situada en las montañas de los Andes en Perú. Construida en el siglo XV, es conocida por su impresionante arquitectura de piedra, terrazas agrícolas y vistas panorámicas. La ciudadela está rodeada de un paisaje natural espectacular, que incluye picos montañosos y la selva tropical. Machu Picchu es un símbolo del imperio inca y un importante sitio arqueológico, atrayendo a millones de turistas cada año que buscan explorar su historia y cultura. Fue declarada Patrimonio de la Humanidad por la UNESCO en 1983.",
    imageUrl: "https://th.bing.com/th/id/OIG1.PoALQySJSsa0POGzN211?w=270&h=270&c=6&r=0&o=5&pid=ImgGn",
    facts: {
      yearOfDiscovery: "1911",
      country: "Perú",
      unescoWorldHeritage: "1983"
    }
  },
  {
    id: "eiffel-tower",
    name: "Torre Eiffel",
    shortDescription: "Icono de París y uno de los monumentos más reconocidos del mundo.",
    description: "La Torre Eiffel, construida en 1889 como una entrada a la Exposición Universal, es uno de los monumentos más icónicos del mundo. Ubicada en París, Francia, la torre de hierro forjado se eleva a 324 metros y ofrece vistas panorámicas impresionantes de la ciudad. Originalmente criticada por su diseño, hoy es un símbolo de la ingeniería moderna y un destino turístico principal. Millones de visitantes suben a la torre cada año para disfrutar de las vistas y la experiencia única de estar en uno de los puntos más altos de París.",
    imageUrl: "https://th.bing.com/th/id/OIG1.QVWgG_kKL6D2wzMK852o?w=270&h=270&c=6&r=0&o=5&pid=ImgGn",
    facts: {
      yearOfDiscovery: "1889",
      country: "Francia",
      unescoWorldHeritage: "1985"
    }
  },
  {
    id: "great-wall-of-china",
    name: "La Gran Muralla China",
    shortDescription: "Antigua muralla defensiva que se extiende por miles de kilómetros.",
    description: "La Gran Muralla China es una de las estructuras más impresionantes construidas por el ser humano. Esta antigua fortificación fue erigida para proteger a China de invasiones, extendiéndose a lo largo de miles de kilómetros desde el desierto de Gobi hasta el Mar Amarillo. Construida y reconstruida desde el siglo VII a.C. hasta el siglo XVII, la muralla está compuesta por diversas secciones de piedra, ladrillo y tierra apisonada. La Gran Muralla es un símbolo de la tenacidad y la capacidad de organización de la civilización china.",
    imageUrl: "https://th.bing.com/th/id/OIG2.zy2P5Hr1zC7YiR6isOJn?w=270&h=270&c=6&r=0&o=5&pid=ImgGn",
    facts: {
      yearOfDiscovery: "No aplica",
      country: "China",
      unescoWorldHeritage: "1987"
    }
  },
  {
    id: "taj-mahal",
    name: "Taj Mahal",
    shortDescription: "Mausoleo de mármol blanco, símbolo del amor eterno.",
    description: "El Taj Mahal, ubicado en Agra, India, es un mausoleo de mármol blanco construido por el emperador mogol Shah Jahan en memoria de su esposa Mumtaz Mahal. Completado en 1653, es una obra maestra de la arquitectura mogol, combinando elementos islámicos, persas, otomanos e indios. El Taj Mahal es famoso por su simetría perfecta, sus intrincados detalles y su cúpula de mármol que refleja los colores del cielo. Es uno de los destinos turísticos más visitados del mundo y fue designado Patrimonio de la Humanidad por la UNESCO en 1983.",
    imageUrl: "https://th.bing.com/th/id/OIG2.2i.mKjNf.OaBcBVI959O?w=270&h=270&c=6&r=0&o=5&pid=ImgGn",
    facts: {
      yearOfDiscovery: "1653",
      country: "India",
      unescoWorldHeritage: "1983"
    }
  },
